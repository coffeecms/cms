        ...
        <div class="row">
                    ...
                    <div class="card" style='margin-top:20px;'>
                        <div class="card-header border-0">
                            <h3 class="card-title"><?php echo $plugin_name;?></h3>
...
<script>
    ...
    pageData['plugin_name']='<?php echo $plugin_name;?>';
</script>
...
$(document).on('click','.btnSaveContent',function(){
  ...
  sendData['plugin_name']=pageData['plugin_name'];
  sendData['content']=$('.file_content').val().trim();
 
  postData(API_URL+'save_plugin_file_content', sendData).then(data => {
    // console.log(data); // JSON data parsed by `data.json()` call
