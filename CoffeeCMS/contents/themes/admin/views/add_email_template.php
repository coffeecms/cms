  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><?php echo get_text_by_lang('Add new email template','admin');?></h1>
          </div><!-- /.col -->
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 ">
                   <?php echo $alert;?>
                        ...
                        <p>
                            <button type="button" class="btn btn-primary btn-addnew" ><i class='fas fa-thumbs-up'></i> <?php echo get_text_by_lang('Add new','admin');?></button>
                        </p>  
              </div>
            </div>            
          </div>
...
masterDB['media_selected_callback']=function(theMediaUrl){
  ...
  $(document).on('click','.btn-addnew',function(){
    ...
    sendData['type']='1';
    postData(API_URL+'insert_new_email_template', sendData).then(data => {
