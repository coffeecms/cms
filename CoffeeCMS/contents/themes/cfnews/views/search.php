    ...
    <div class='row margin-top-10'>
      ...
      <div class='col-lg-12 col-md-12 col-sm-12 '>
        ...
        <ul class="pagination">
            ...
            <a class="page-link" href="<?php echo SITE_URL;?>search?k=<?php echo $keywords;?>&page=<?php echo $page_prev;?>" tabindex="-1" aria-disabled="true">Previous</a>
            </li>

            <?php if((int)$page > 1){ ?>
            <li class="page-item"><a class="page-link" href="<?php echo SITE_URL;?>search?k=<?php echo $keywords;?>&page=<?php echo $page_prev;?>"><?php echo $page_prev;?></a></li>
            <?php } ?>

            <li class="page-item active" aria-current="page">
            <a class="page-link" href="<?php echo SITE_URL;?>search?k=<?php echo $keywords;?>&page=<?php echo $page;?>"><?php echo $page;?></a>
            </li>
            <li class="page-item"><a class="page-link" href="<?php echo SITE_URL;?>search?k=<?php echo $keywords;?>&page=<?php echo $page_next;?>"><?php echo $page_next;?></a></li>
            <li class="page-item">
            <a class="page-link" href="<?php echo SITE_URL;?>search?k=<?php echo $keywords;?>&page=<?php echo $page_next;?>">Next</a>
            </li>
        </ul>
        </nav>
      </div>
