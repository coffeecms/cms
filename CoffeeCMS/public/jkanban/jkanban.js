  ...
  this.jKanban = function () {
    ...
    this.addBoards = function (boards, isInit) {
      ...
      for (var boardkey in boards) {
        ...
        boardNode.dataset.order = parseInt(board['sort_order'])
        boardNode.dataset['sort_order'] = parseInt(board['sort_order'])
        boardNode.dataset['project_c'] = board['project_c']
        ...
        headerBoard.innerHTML =
          '<div class="kanban-title-board">' + board.title + ' <span style="float:right;"><span class="icon-add-message" data-board-title="' + board.title + '" data-board_c="' + board.board_c + '" style="cursor:pointer;margin-right:10px;" title="Add note"><i class="fas fa-plus"></i></span><span class="icon-delete-board" data-board_c="' + board.board_c + '" data-board-title="' + board.title + '" style="cursor:pointer;margin-right:10px;" title="Add note"><i class="fas fa-trash"></i></span></span></div>'
        //content board
        ...
        for (var itemkey in board.item) {
          //create item
          if(typeof board.item[itemkey]!='object')
          {
            continue;
          }
          ...
          nodeItem.innerHTML = __buildItemTitle('<span style="position:absolute;right:5px;top:0px;"><span data-board_c="'+itemKanban.board_c+'" data-messageid="'+itemKanban.message_id+'" class="icon-view-comment-note" title="View comments" style="cursor:pointer;margin-right:10px;color:#A7A7A7;"><i class="fas fa-comment-alt"></i></span><span data-board_c="'+itemKanban.board_c+'" data-messageid="'+itemKanban.message_id+'" class="icon-edit-note" title="Edit this note" style="cursor:pointer;margin-right:10px;color:#A7A7A7;"><i class="fas fa-edit"></i></span><span class="icon-delete-note" data-board_c="'+itemKanban.board_c+'" data-messageid="'+itemKanban.message_id+'"  title="Delete this note" style="cursor:pointer;color:#A7A7A7;"><i class="fas fa-trash"></i></span></span>'+itemKanban.title)
          //add function
          nodeItem.clickfn = itemKanban.click
          nodeItem.dragfn = itemKanban.drag
          nodeItem.message_id = itemKanban.message_id
          nodeItem.board_c = itemKanban.board_c
